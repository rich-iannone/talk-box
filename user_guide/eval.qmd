...
bot_a = (
    tb.ChatBot(name="Eval: code_reviewer @ anthropic:claude-sonnet-4-20250514")
    .persona_pack("code_reviewer")
    .mock_responses([
...
results = tb.eval(
    variants={
        "anthropic:claude-sonnet-4-20250514": bot_a,
        "github:gpt-4o": bot_b,
    },
...
results = tb.eval_suite(
    ...
    models=[
        "github:gpt-4o",
        "github:o3-mini",
        "github:claude-sonnet-4-20250514",
    ],
    judge="anthropic:claude-sonnet-4-20250514",
)
```
...
results = tb.EvalResults(
    results=[
        tb.EvalResult(
            variant="anthropic:claude-sonnet-4-20250514",
