"""
React Chat Integration for Talk Box

This module enables React chat support when imported.
The actual integration happens lazily when bot.show("react") is called.
"""
